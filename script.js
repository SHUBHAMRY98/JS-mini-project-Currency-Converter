const dropList = document.querySelectorAll(".drop-list select");
 fromCurrency = document.querySelectorAll(".from .select-box select")[0];
 toCurrency = document.querySelectorAll(".to .select-box select")[0];
...
getButton.addEventListener("click", e =>{
    ...
    let apiKey ="7e30b719e493168290eae4df"
